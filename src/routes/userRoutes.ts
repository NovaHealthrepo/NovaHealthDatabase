...
router.put("/profiles/:userID", async (req: Request, res: Response) => {
  try {
    ...
    if (secondPhone !== undefined) data.secondPhone = secondPhone;
    if (secondContactPerson !== undefined)
      data.secondContactPerson = secondContactPerson;
    if (gender !== undefined) data.gender = gender;
    if (birth !== undefined) data.birth = new Date(birth);
    if (IDcard !== undefined) data.IDcard = IDcard;
...
// DELETE profile
router.delete("/profiles/:userID", async (req: Request, res: Response) => {
  try {
